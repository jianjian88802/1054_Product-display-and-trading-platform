                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button
                                    v-if="isAuth('heimingdan','从黑名单中删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                                    type="success" icon="el-icon-edit" size="mini" @click="quxiao(scope.row.id)">{{
                                contents.tableBtnFont == 1?'从黑名单中删除':'' }}
                            </el-button>
                            <el-button
                                    v-if="isAuth('heimingdan','从黑名单中删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
                                    type="success" size="mini" @click="quxiao(scope.row.id)">{{ contents.tableBtnFont ==
                                1?'从黑名单中删除':'' }}<i class="el-icon-edit el-icon--right"/></el-button>
                            <el-button v-if="isAuth('heimingdan','从黑名单中删除') && contents.tableBtnIcon == 0" type="success"
                                       size="mini" @click="quxiao(scope.row.id)">{{ contents.tableBtnFont ==
                                1?'从黑名单中删除':'' }}
                            </el-button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            quxiao(id) {
                this.$confirm(`确定要将这个用户从黑名单中删除吗?`, "提示", {
                    confirmButtonText: "确定",
                    cancelButtonText: "取消",
                    type: "warning"
                }).then(() => {
                    this.$http({
                    url: "yonghu/quxiao?ids=" + id,
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0
            )
